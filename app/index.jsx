      ...
      <View style={styles.container}>
        <View style={styles.authContainer}>
          ...
          <Text style={styles.subtitle}>
            Share your dance photos and track your progress
          </Text>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>
              Be the first to share your dance photos!
            </Text>
          </View>
        }
      />
...
// ----- STYLES MUST BE OUTSIDE THE FUNCTION -----
const styles = StyleSheet.create({
  ...
  logoutButton: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: '#333', borderRadius: 8 },
  logoutText: { color: '#fff', fontSize: 16, fontWeight: '500' },
  listContainer: { paddingHorizontal: 20, paddingBottom: 100 },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 60 },
  emptyText: { fontSize: 24, fontWeight: 'bold', color: '#fff', marginBottom: 8 },
  emptySubtext: { fontSize: 16, color: '#888' },
  ...
  authButton: { backgroundColor: '#ff6b6b', paddingHorizontal: 40, paddingVertical: 16, borderRadius: 12, marginBottom: 16, width: '100%', alignItems: 'center' },
  signupButton: { backgroundColor: 'transparent', borderWidth: 2, borderColor: '#ff6b6b' },
  authButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  signupButtonText: { color: '#ff6b6b' },
});
